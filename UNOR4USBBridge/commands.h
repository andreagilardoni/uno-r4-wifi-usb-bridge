...
enum class Commands: int {
   WIFISCAN, RESET, RESTART_BOOTLOADER, GMR, GENERIC_CMD, FILESYSTEM, MOUNTFS, EXIT, MODE, BEGINSTA, GETSTATUS,
   RECONNECT, DISCONNECT, BEGINSOFTAP, MACSTA, MACSOFTAP, DISCONNECTSOFTAP, AUTOCONNECT, IPSTA, IPSOFTAP, IPV6,
   GETRSSI, GETSSID, GETBSSID, GETSOFTAPSSID, HOSTNAME, BEGINCLIENT, CLIENTSTATE, CLIENTCONNECTIP, CLIENTCONNECTNAME,
   CLIENTCONNECT, CLIENTSEND, CLIENTRECEIVE, CLIENTCLOSE, IPCLIENT, BEGINSERVER, CLIENTCONNECTED, SSLBEGINCLIENT,
   SETCAROOT, SETECCSLOT, SSLCLIENTSTATE, SSLCLIENTCONNECTNAME, SSLCLIENTCONNECT, SETIP, GETHOSTBYNAME, AVAILABLE,
   PEEK, CLIENTFLUSH, REMOTEIP, REMOTEPORT, CLIENTSTATUS, SOFTRESETWIFI, SSLCLIENTCONNECTIP, SSLCLIENTSEND,
   SSLCLIENTCLOSE, SSLIPCLIENT, SSLCLIENTCONNECTED, SSLCLIENTRECEIVE, SSLAVAILABLE, SSLCLIENTSTATUS, SSLCLIENTFLUSH,
   SSLREMOTEIP, SSLREMOTEPORT, SSLPEEK, SERVERAVAILABLE, SERVERACCEPT, SERVEREND, UDPBEGIN, UDPBEGINMULTI, UDPBEGINPACKET,
   UDPBEGINPACKETMULTI, UDPBEGINPACKETNAME, UDPBEGINPACKETIP, UDPENDPACKET, UDPWRITE, UDPPARSE, UDPAVAILABLE, UDPREAD,
   UDPPEEK, UDPFLUSH, UDPREMOTEIP, UDPREMOTEPORT, UDPSTOP, FWVERSION, SOFTAPCONFIG, SERVERWRITE, HCI_BEGIN, HCI_END,
   HCI_WAIT, HCI_READ, HCI_WRITE, HCI_AVAILABLE, OTA_SETCAROOT, OTA_BEGIN, OTA_DOWNLOAD, OTA_VERIFY, OTA_UPDATE,
   OTA_RESET, PREF_BEGIN, PREF_END, PREF_CLEAR, PREF_REMOVE, PREF_PUT, PREF_GET, PREF_LEN, PREF_STAT, SOFTSE_BEGIN,
   SOFTSE_END, SOFTSE_SERIAL, SOFTSE_RND, SOFTSE_PRI_KEY, SOFTSE_PUB_KEY, SOFTSE_WRITE_SLOT, SOFTSE_READ_SLOT,
   SOFTSE_S_V_BUF_SET, SOFTSE_SIGN_GET, SOFTSE_VERIFY_GET, SOFTSE_SHA256_GET,
};
